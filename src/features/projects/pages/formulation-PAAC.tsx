...
const FormulationPAACEdition = () => {
    ...
    const { formState: { errors: formErrors }, control: formControl, getValues: formGetValues } = useForm<IAntiCorruptionPlanFields>({
        resolver: yupResolver(antiCorruptionPlanValidator) 
    });
                            ...
                            <div className="card-table">
                                <section className="select_PAAC">
                                    <SelectComponent
                                        control={control}
                                        idInput={"year"}
                                        className={`select-basic span-width ${errors?.year ? 'error' : ''}`}
                                        label="Año"
                            ...
                            <section className="card-table mt-15">
                                ...
                                <div className="select_group">
                                    <SelectComponent
                                        ...
                                        className={`select-basic span-width ${errors?.component_desc ? 'error' : ''}`}
