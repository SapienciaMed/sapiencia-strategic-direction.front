...
const AntiCorruptionExpansibleTable = ({ columns, actions, data, widthTable, hideActions, hidePagination = false, horizontalScroll = false, title = "" }: IProps<any>): React.JSX.Element => {
...
export default React.memo(AntiCorruptionExpansibleTable);